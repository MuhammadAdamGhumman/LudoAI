...
namespace LGClient
{
    ...
    public class AgentManager
    {
        ...
        void MovePieceInBoard(Int16 score)
        {
            ...
            if (myState.Pieces[forward_piece] > -1 && myState.Pieces[forward_piece] < 56 && (myState.Pieces[forward_piece] + score) <= 56)
            {
                myState.Pieces[forward_piece] += score;
